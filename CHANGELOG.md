...
**完整差异**: https://github.com/YandaTerminal/yanda-terminal/compare/v0.11.2-test...v0.19.19-810
...
**完整差异**: https://github.com/YandaTerminal/yanda-terminal/compare/v0.11.4514...v0.11.1
...
| Android | `app-release.apk` |
| HarmonyOS | `entry-default-unsigned.hap` |
| Windows | `YandaTerminal_0.11.1_x64-setup.exe` |
| Linux | `YandaTerminal_0.11.1_amd64.AppImage` |

> PWA: https://yanda.dpdns.org


## v0.11.0-test2 (2026-07-22)
...
**完整差异**: https://github.com/YandaTerminal/yanda-terminal/compare/v0.11.0-test...v0.11.0-test2
...
**Full diff**: https://github.com/YandaTerminal/yanda-terminal/compare/v0.11.0...v0.11.4514
...
| iOS | `yanda-terminal-ios.ipa` |
| HarmonyOS | `entry-default-unsigned.hap` |
| Windows | `YandaTerminal_0.11.4514_x64-setup.exe` |
| Linux | `YandaTerminal_0.11.4514_amd64.AppImage` |
| macOS | `YandaTerminal_0.11.4514_aarch64.dmg` |
